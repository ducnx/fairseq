python train.py manifest/train --save-dir model/test --num-workers 6 --fp16 --max-update 400000 \
...
--log-keys ["prob_perplexity","code_perplexity","temp"] --vq-type kmeans --loss-weights [1] --vq-groups 2 --vq-depth 2 \
