...
@dataclass
class MIMIC3_MaskedLMConfig(FairseqDataclass):
    data: str = field(
        default=MISSING,
        metadata={
...
@register_task("mimic3_masked_lm", dataclass=MIMIC3_MaskedLMConfig)
class MIMIC3_MaskedLMTask(FairseqTask):

    cfg: MIMIC3_MaskedLMConfig

    """Task for training masked language models (e.g., BERT, RoBERTa)."""

    def __init__(self, cfg: MIMIC3_MaskedLMConfig, dictionary):
        super().__init__(cfg)
    ...
    @classmethod
    def setup_task(cls, cfg: MIMIC3_MaskedLMConfig, **kwargs):
